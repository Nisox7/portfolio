...
export const Project = (project: ProjectType) => {
  ...
  return (
    <div className="grid grid-cols-4 gap-4 pb-4 overflow-hidden">
      ...
      <div className="col-span-full lg:row-start-1 lg:row-end-4 lg:col-start-1 lg:col-end-3 opacity-0 mobile-animation videoSection">
        <Image
          className="rounded-xl border-1 border-[#212121] object-cover w-full h-full"
          src={imgUrl}
          disableSkeleton
        ></Image>
      </div>
      ...
      <Card
        isHoverable={!!githubUrl}
        className={`${
          websiteUrl === "NONE"
            ? "lg:col-start-3 col-span-4"
            : "lg:col-start-4 col-span-2"
        } lg:row-start-3 lg:row-end-4 lg:max-h-24 lg:col-end-5 mobile-animation websiteUrlCard
    ${githubUrl ? "bg-white dark:bg-neutral-900 opacity-100" : "bg-gray-200 dark:bg-neutral-800 opacity-50 cursor-not-allowed"}
  `}
      >
        {githubUrl ? (
          <Link
